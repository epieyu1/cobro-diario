-- Limpia warnings de PL/pgSQL en el helper de cronograma sin cambiar su contrato.
...
begin
  ...
  for installment_number in 1..p_total_installments loop
    ...
    interest_amount := case
      when installment_number = p_total_installments then
