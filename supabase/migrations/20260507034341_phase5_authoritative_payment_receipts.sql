-- BR-3 materializa el recibo confirmado por servidor sin abrir lecturas privilegiadas.
-- El frontend solo debe mostrar comprobante autoritativo cuando exista remotePaymentId
-- y este RPC lo rehidrate desde PostgreSQL bajo el mismo alcance RLS del actor autenticado.
...
'Recibo autoritativo de BR-3. Lee el pago ya confirmado en PostgreSQL bajo RLS del actor autenticado y devuelve el desglose materializado por cuota para no reconstruir el comprobante desde IndexedDB.';
