-- Recompone originate_loan() contra el helper de roles vigente.
-- Esta migracion solo vuelve a publicar la version canonica actual del RPC para que
-- LANDING deje de depender de firmas legacy borradas en el saneamiento previo.
